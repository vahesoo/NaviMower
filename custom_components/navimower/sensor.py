...
SENSORS: tuple[NavimowSensorDescription, ...] = (
    ...
    NavimowSensorDescription(
        ...
        value_fn=lambda d: d.get("display_state") or d.get("state"),
        attrs_fn=lambda d: {
            "vendor_state": d.get("state"),
            "state_code": d.get("state_code"),
            "activity": d.get("activity"),
            "weather_state": d.get("weather_state"),
            "weather_hold_active": d.get("weather_hold_active"),
            "weather_hold_reason": d.get("weather_hold_reason"),
            "weather_hold_reasons": d.get("weather_hold_reasons"),
            "weather_source": d.get("weather_state_source"),
            "weather_age_s": d.get("weather_state_age"),
            "weather_fresh": d.get("weather_state_fresh"),
            "rain_level": d.get("weather_rain_level"),
            "rain_delay_active": d.get("rain_delay_active"),
            "rain_delay_remaining_minutes": d.get("rain_delay_remaining_minutes"),
            "rain_delay_until": d.get("rain_delay_until"),
        },
    ),
    NavimowSensorDescription(
        key="weather_state",
        ...
        value_fn=lambda d: d.get("weather_state"),
        attrs_fn=lambda d: {
            "hold_active": d.get("weather_hold_active"),
            "hold_reason": d.get("weather_hold_reason"),
            "active_conditions": d.get("weather_hold_reasons"),
            "unknown_conditions": d.get("weather_unknown_reasons"),
            "rain": d.get("weather_rain_state"),
            "snow": d.get("weather_snow_state"),
            "strong_wind": d.get("weather_storm_state"),
            "frost": d.get("weather_frost_state"),
            "high_temperature": d.get("weather_high_temperature_state"),
            "rain_level": d.get("weather_rain_level"),
            "source": d.get("weather_state_source"),
            "source_age": d.get("weather_state_age"),
            "fresh": d.get("weather_state_fresh"),
            "rain_delay_enabled": d.get("rain_delay_enabled"),
            "rain_delay_configured_minutes": d.get("rain_delay_configured_minutes"),
            "rain_delay_active": d.get("rain_delay_active"),
            "rain_delay_started_at": d.get("rain_delay_started_at"),
            "rain_delay_until": d.get("rain_delay_until"),
            "rain_delay_remaining_minutes": d.get("rain_delay_remaining_minutes"),
        },
    ),
    NavimowSensorDescription(
        ...
        state_class=SensorStateClass.MEASUREMENT,
        value_fn=lambda d: d.get("rain_delay_remaining_minutes", 0),
        attrs_fn=lambda d: {
            "active": d.get("rain_delay_active"),
            "configured_minutes": d.get("rain_delay_configured_minutes"),
            "started_at": d.get("rain_delay_started_at"),
            "until": d.get("rain_delay_until"),
            "remaining_seconds": d.get("rain_delay_remaining_seconds"),
        },
    ),
    NavimowSensorDescription(
        key="state_code",
    ...
    NavimowSensorDescription(
        ...
        attrs_fn=lambda d: {
            ...
            "source": d.get("target_zone_immediate_source"),
            ...
            "target_age_seconds": d.get("target_zone_immediate_age_seconds"),
...
class NavimowerMapDataSensor(NavimowEntity, SensorEntity):
    ...
    def extra_state_attributes(self) -> dict[str, Any]:
        ...
        return {
            ...
            "display_state": self.data.get("display_state") or self.data.get("state"),
            "weather_state": self.data.get("weather_state"),
            "weather_hold_active": self.data.get("weather_hold_active"),
            "weather_hold_reason": self.data.get("weather_hold_reason"),
            "weather_state_fresh": self.data.get("weather_state_fresh"),
            "rain_delay_active": self.data.get("rain_delay_active"),
            "rain_delay_remaining_minutes": self.data.get("rain_delay_remaining_minutes"),
            "rain_delay_until": self.data.get("rain_delay_until"),

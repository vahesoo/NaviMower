...
CONF_REFRESH_TOKEN: Final = "refresh_token"  # private Passport refresh token
...
STATE_MAP_EDIT: Final = "0202"
STATE_MAP_EDIT_MANUAL: Final = "0258"
...
MAP_EDIT_STATES: Final = {STATE_MAP_EDIT, STATE_MAP_EDIT_MANUAL}

VEHICLE_STATE_TO_ACTIVITY: Final[dict[str, str]] = {
    STATE_IDLE_DOCKED: ACTIVITY_DOCKED,
    STATE_IDLE_DOCKED_POST: ACTIVITY_DOCKED,
    STATE_MAP_EDIT: ACTIVITY_PAUSED,
    STATE_MAP_EDIT_MANUAL: ACTIVITY_PAUSED,
...
VEHICLE_STATE_LABELS: Final[dict[str, str]] = {
    ...
    STATE_MAP_EDIT: "Map edit",
    STATE_MAP_EDIT_MANUAL: "Map edit",
    STATE_MOWING: "Mowing",
